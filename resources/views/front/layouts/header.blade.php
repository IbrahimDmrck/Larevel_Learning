...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="cleanblog/assets/favicon.ico" />
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="{{route('index')}}">Blog Sitesi</a>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('@yield('bg',asset('cleanblog/assets/img/home-bg.jpg'))')">
